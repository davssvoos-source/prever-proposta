// Prospecção — a LISTA, agora uma aba dentro do Comercial (R38).
//
// Era página própria em /prospeccao com item no menu lateral. O Davi mandou
// trazê-la para dentro do Comercial: prospecção É o começo do funil, e ter
// duas portas para o mesmo domínio faz escolher antes de trabalhar.
//
