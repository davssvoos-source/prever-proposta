...
**Fonte de verdade:** o código e `docs/PRODUTO.md` (regras R1–R173). Se um
...
(o que o Davi ditou) → **visao-geral** → **desenvolvimento-e-verificacao** → o
segmento onde vai trabalhar.
